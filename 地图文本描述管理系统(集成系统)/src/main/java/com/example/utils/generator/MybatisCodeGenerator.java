...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "map2text";   // 数据库名称，必填
    private static final String[] table = {"description", "Description"};   // 必填，第一个是表名，第二个是实体类的名字
    private static final String modelName = "描述信息";   // 必填
